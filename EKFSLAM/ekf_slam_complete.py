...
M_DIST_TH = 5.0  # Threshold of Mahalanobis distance for data association.
...
def motion_model(x, u):
    ...
    xp = np.array([[x[0] + u[0]*DT * math.cos(x[2])],
...
def ekf_slam(xEst, PEst, u, y):
    ...
    # Predict
    A, B = jacob_motion(xEst[0:S], u) # Fv and Fu
